...
def test_eff_stack_is_measured_against_the_shover():
    ...
    39-битовым, то есть «глубже пуш-фолд-зоны». Замер на фикстурах при этой
    правке: так терялись 23 точки, где Hero отвечал на олл-ин.
    ...
    # Стек шовера за вычетом анте: 6200 - 200. Анте уже в банке, глубиной игры
    # оно не является.
